...
granted_loan = st.slider("Granted Loan Amount ($) - Used for Log Transform", min_value=5000.0, max_value=150000.0, value=30000.0, step=1000.0)
...
input_data['lon_Granted_Loan_Amount'] = np.log1p(input_data['Granted_Loan_Amount'])
